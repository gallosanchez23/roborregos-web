<?php
  ...
  $_ENV["HTTP_ROBORREGOS_EMAIL_DOMAIN"] = getenv('HTTP_ROBORREGOS_EMAIL_DOMAIN');
  $_ENV["HTTP_ROBORREGOS_EMAIL_USERNAME"] = getenv('HTTP_ROBORREGOS_EMAIL_USERNAME');
  $_ENV["HTTP_ROBORREGOS_EMAIL_PASSWORD"] = getenv('HTTP_ROBORREGOS_EMAIL_PASSWORD');
  $_ENV["HTTP_RECAPTCHA_SECRET"] = getenv('HTTP_RECAPTCHA_SECRET');
