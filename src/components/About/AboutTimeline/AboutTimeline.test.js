  ...
  "events": [
    {
      ...
      "description": "Unfortunately, both the TMR and Robocup Jr. were cancelled for this year, yet we continued working, creating online courses and webinars as well as participating in different tech events."
    },
    {
      "date": "February 2020",
      "month": 2,
...
const { events, years } = JSON.parse(information_timeline)
...
it('<AboutTimeline> Renders correctly', () => {
  act(() => {
    render(<AboutTimeline events={events} years={years} />, container)
  })
})
