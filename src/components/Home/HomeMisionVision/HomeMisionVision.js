              ...
              <div className="mision-overlay row">
                    <div className="col-sm-7">
                          <div className="text-mision"> 
                              <h1>Mission </h1>
                              <p> Create a community that integrates students, teachers, alumni, companies, institutions and society in general to promote the development of robotics in Mexico.</p>
                          </div>
                    </div>
              </div>
        </div>
